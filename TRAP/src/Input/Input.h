...
namespace TRAP
{
	...
	public:
		...
		static bool IsGamepadButtonPressed(Joystick joystick, GamepadButton button);
		static bool IsRawMouseInputSupported();
		static bool IsJoystickConnected(Joystick joystick);
		static bool IsJoystickGamepad(Joystick joystick);
	...
	private:		
		...
		static std::vector<Controller> m_joysticks;
	};
}
