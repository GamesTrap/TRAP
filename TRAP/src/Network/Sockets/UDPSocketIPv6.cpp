...
TRAP::Network::Socket::Status TRAP::Network::UDPSocketIPv6::Bind(const u16 port, const IPv6Address& address)
{
	...
	if(::bind(GetNativeHandle(), reinterpret_cast<const sockaddr*>(&addr), sizeof(addr)) == -1)
	{
...
TRAP::Network::Socket::Status TRAP::Network::UDPSocketIPv6::Receive(void* const data, const usize size,
                                                                    usize& received,
																	TRAP::Optional<IPv6Address>& remoteAddress,
...
#endif
	sockaddr_in6 address = INTERNAL::Network::SocketImpl::CreateAddress(addr, 0u);
...
TRAP::Network::Socket::Status TRAP::Network::UDPSocketIPv6::Receive(Packet& packet, TRAP::Optional<IPv6Address>& remoteAddress,
                                                                    u16& remotePort)
{
	ZoneNamedC(__tracy, tracy::Color::Azure, (GetTRAPProfileSystems() & ProfileSystems::Network) != ProfileSystems::None);
