...
namespace TRAP
{
	...
	public:
		...
		inline static constexpr auto WindowVersion = "[21w34a3]";
		...
		inline static constexpr auto SamplerPrefix = "[Sampler] ";
		inline static constexpr auto VertexBufferPrefix = "[VertexBuffer] ";
