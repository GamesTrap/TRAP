...
std::unordered_map<std::string, TRAP::Ref<TRAP::Graphics::SubTexture2D>, TRAP::Utils::StringHasher> Sprites;
...
[[nodiscard]] const std::unordered_map<std::string, TRAP::Ref<TRAP::Graphics::SubTexture2D>, TRAP::Utils::StringHasher>& TRAP::Graphics::SpriteManager::GetSprites() noexcept
{
	ZoneNamedC(__tracy, tracy::Color::Red, (GetTRAPProfileSystems() & ProfileSystems::Graphics) != ProfileSystems::None &&
