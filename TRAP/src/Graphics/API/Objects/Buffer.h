...
namespace TRAP::Graphics
{
	...
	public:
		...
		[[nodiscard]] constexpr DescriptorType GetDescriptors() const noexcept;
		/// @brief Retrieve the usage of the buffer memory.
		/// @return Usage of the buffer memory.
		[[nodiscard]] constexpr ResourceMemoryUsage GetMemoryUsage() const noexcept;
		...
		[[nodiscard]] virtual bool MapBuffer(const ReadRange& range = {}) = 0;
...
[[nodiscard]] constexpr TRAP::Graphics::DescriptorType TRAP::Graphics::Buffer::GetDescriptors() const noexcept
{
...
[[nodiscard]] constexpr TRAP::Graphics::ResourceMemoryUsage TRAP::Graphics::Buffer::GetMemoryUsage() const noexcept
{
