...
namespace TRAP::Graphics::API
{
	...
	public:
		...
		const std::vector<std::string>& GetUsedPhysicalDeviceExtensions() const noexcept;
		...
		VkSemaphore& GetReflexSemaphore() noexcept;
