...
namespace TRAP::Graphics::API
{
	...
	void VulkanContext::SetVSyncIntervalInternal(const unsigned int interval)
	{
		m_vsync = interval;
	}

	void VulkanContext::Present(Window* window)
	{
	}
	...
	void VulkanContext::DeInitSurface()
	{
		if (m_surface)
		{
	...
	void VulkanContext::DeInitSwapchain()
	{
		if(m_swapchain)
		{
	...
	void VulkanContext::InitImageViews()
	{
	...
	void VulkanContext::DeInitImageViews()
	{
	...
	std::vector<VkSurfaceFormatKHR> VulkanContext::GetAvailableSurfaceFormats(VkPhysicalDevice physicalDevice) const
	{
	...
	std::vector<VkSurfaceFormatKHR> VulkanContext::GetAvailableSurfaceFormats() const
	{
	...
	std::vector<VkPresentModeKHR> VulkanContext::GetAvailableSurfacePresentModes(VkPhysicalDevice physicalDevice) const
	{
	...
	std::vector<VkPresentModeKHR> VulkanContext::GetAvailableSurfacePresentModes() const
	{
	...
	VkSurfaceFormatKHR VulkanContext::ChooseSwapchainSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableSurfaceFormats)
	{
	...
	VkPresentModeKHR VulkanContext::ChooseSwapchainSurfacePresentMode(const std::vector<VkPresentModeKHR>& availableSurfacePresentModes)
	{
	...
	VkExtent2D VulkanContext::ChooseSwapchainExtent() const
	{
