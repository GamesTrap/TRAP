...
template <class T>
TRAP::Maths::tVec4<T> operator+(TRAP::Maths::tVec4<T> left, const TRAP::Maths::tVec2<T>& right)
{
...
template <class T>
TRAP::Maths::tVec4<T> operator+(TRAP::Maths::tVec4<T> left, const TRAP::Maths::tVec3<T>& right)
{
	return left.Add(right);
}
...
template <class T>
TRAP::Maths::tVec4<T> operator+(TRAP::Maths::tVec4<T> left, const TRAP::Maths::tVec4<T>& right)
{
	return left.Add(right);
}
...
template <class T>
TRAP::Maths::tVec4<T> operator+(TRAP::Maths::tVec4<T> left, T value)
{
...
template <class T>
std::ostream& operator<<(std::ostream& stream, const TRAP::Maths::tVec4<T>& vector)
{
