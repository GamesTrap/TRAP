...
[[nodiscard]] std::array<u8, 4u> TRAP::Utils::Hash::Adler32(const void* const data, u64 length)
{
...
[[nodiscard]] std::array<u8, 4u> TRAP::Utils::Hash::Adler32(const std::string_view str)
{
	ZoneNamedC(__tracy, tracy::Color::Violet, (GetTRAPProfileSystems() & ProfileSystems::Utils) != ProfileSystems::None &&
