...
newaction
{
    ...
    execute = function()
        ...
        local sourcePath = _MAIN_SCRIPT_DIR .. "/gamecontrollerdb.txt"
        ...
        -- Donwload mappings from SDL
        os.execute("curl -o gamecontrollerdb.txt https://raw.githubusercontent.com/gabomdq/SDL_GameControllerDB/master/gamecontrollerdb.txt")
