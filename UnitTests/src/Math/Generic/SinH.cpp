...
consteval void RunSinHVecCompileTimeTests()
{
    ...
    static_assert(TRAP::Math::All(TRAP::Math::Equal(TRAP::Math::SinH(T(typename T::value_type(-0.5))), T(-0.521095), T(0.000001f))));
    static_assert(TRAP::Math::All(TRAP::Math::Equal(TRAP::Math::SinH(T(typename T::value_type(0.0))), T(0.0), Epsilon)));
    static_assert(TRAP::Math::All(TRAP::Math::Equal(TRAP::Math::SinH(T(typename T::value_type(0.001))), T(0.001), T(0.0000001f))));
    static_assert(TRAP::Math::All(TRAP::Math::Equal(TRAP::Math::SinH(T(typename T::value_type(0.5))), T(0.521095), T(0.000001f))));
    static_assert(TRAP::Math::All(TRAP::Math::Equal(TRAP::Math::SinH(T(typename T::value_type(1.0))), T(1.1752), T(0.00001f))));
    static_assert(TRAP::Math::All(TRAP::Math::Equal(TRAP::Math::SinH(T(typename T::value_type(5.0))), T(74.2032), T(0.0001f))));
}
