#ifndef _GAMESTRAP_PARTICLESYSTEM2DLAYER_H_
#define _GAMESTRAP_PARTICLESYSTEM2DLAYER_H_
...
// 		TRAP::Graphics::RenderCommand::SetBlend(false);
...
#endif /*_GAMESTRAP_PARTICLESYSTEM2DLAYER_H_*/