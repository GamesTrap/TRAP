...
public:
	...
	void OnImGuiRender() override
	{
		...
		ImGui::ColorEdit4("Spawn Color", &std::get<0u>(m_particle.ColorBegin));
		ImGui::ColorEdit4("Decay Color", &std::get<0u>(m_particle.ColorEnd));
		ImGui::DragFloat("Life Time", &m_particle.LifeTime, 0.1f, 0.0f, 1000.0f);

		static constexpr u32 MinParticles = 1u;
		static constexpr u32 MaxParticles = 100000u;
		...
		ImGui::PlotLines("##frametimeHistory", m_frameTimeHistory.data(), NumericCast<i32>(m_frameTimeHistory.size()), 0, nullptr, 0.0f, 33.0f, ImVec2(200.0f, 50.0f));
		ImGui::End();
	}
