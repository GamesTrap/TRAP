...
{
    normal = normalize(mat3(Matrices.sys_ViewMatrix * ModelMatrix.sys_ModelMatrix[gl_BaseInstance]) * Normal);
    position = (Matrices.sys_ViewMatrix * ModelMatrix.sys_ModelMatrix[gl_BaseInstance] * vec4(Position, 1.0f)).xyz;
}
