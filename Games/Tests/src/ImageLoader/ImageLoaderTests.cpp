...
void ImageLoaderTests::OnAttach()
{
	...
	//TGA
	TRAP::Graphics::TextureManager::Load("TGATest16BPP", "/Textures/TGA/Test16BPP.tga", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("TGATest16BPPRLE", "/Textures/TGA/Test16BPPRLE.tga", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("TGATest24BPP", "/Textures/TGA/Test24BPP.tga", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("TGATest24BPPRLE", "/Textures/TGA/Test24BPPRLE.tga", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("TGATest32BPP", "/Textures/TGA/Test32BPP.tga", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("TGATest32BPPRLE", "/Textures/TGA/Test32BPPRLE.tga", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("TGATestGrayscale", "/Textures/TGA/TestGrayscale.tga", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("TGATestPalette", "/Textures/TGA/TestPalette.tga", TRAP::Graphics::TextureUsage::Static);
	
	//BMP
	TRAP::Graphics::TextureManager::Load("BMPTest8BPPGrayscale", "/Textures/BMP/Test8BPPGrayscale.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest8BPPGrayscaleReversed", "/Textures/BMP/Test8BPPGrayscaleReversed.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest8BPPGrayscaleRLE", "/Textures/BMP/Test8BPPGrayscaleRLE.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest8BPPGrayscaleRLEReversed", "/Textures/BMP/Test8BPPGrayscaleRLEReversed.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest8BPPPalette", "/Textures/BMP/Test8BPPPalette.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest8BPPPaletteReversed", "/Textures/BMP/Test8BPPPaletteReversed.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest8BPPPaletteRLE", "/Textures/BMP/Test8BPPPaletteRLE.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest8BPPPaletteRLEReversed", "/Textures/BMP/Test8BPPPaletteRLEReversed.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest16BPP", "/Textures/BMP/Test16BPP.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest16BPPReversed", "/Textures/BMP/Test16BPPReversed.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest24BPP", "/Textures/BMP/Test24BPP.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest24BPPReversed", "/Textures/BMP/Test24BPPReversed.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest32BPP", "/Textures/BMP/Test32BPP.bmp", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("BMPTest32BPPReversed", "/Textures/BMP/Test32BPPReversed.bmp", TRAP::Graphics::TextureUsage::Static);
	
	//PNG
	TRAP::Graphics::TextureManager::Load("PNGTest8BPPGrayscaleBig", "/Textures/PNG/Test8BPPGrayscaleBig.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest8BPPGrayscaleBigInterlaced", "/Textures/PNG/Test8BPPGrayscaleBigInterlaced.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest8BPPGrayscaleSmaller", "/Textures/PNG/Test8BPPGrayscaleSmaller.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest8BPPGrayscaleSmallest", "/Textures/PNG/Test8BPPGrayscaleSmallest.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest16BPPGrayscaleBig", "/Textures/PNG/Test16BPPGrayscaleBig.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest16BPPGrayscaleBigInterlaced", "/Textures/PNG/Test16BPPGrayscaleBigInterlaced.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest16BPPGrayscaleSmaller", "/Textures/PNG/Test16BPPGrayscaleSmaller.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest16BPPGrayscaleSmallest", "/Textures/PNG/Test16BPPGrayscaleSmallest.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest24BPPBig", "/Textures/PNG/Test24BPPBig.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest24BPPBigInterlaced", "/Textures/PNG/Test24BPPBigInterlaced.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest24BPPSmaller", "/Textures/PNG/Test24BPPSmaller.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest24BPPSmallest", "/Textures/PNG/Test24BPPSmallest.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest48BPPBig", "/Textures/PNG/Test48BPPBig.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest48BPPBigInterlaced", "/Textures/PNG/Test48BPPBigInterlaced.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest48BPPSmaller", "/Textures/PNG/Test48BPPSmaller.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTest48BPPSmallest", "/Textures/PNG/Test48BPPSmallest.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTestPaletteBig", "/Textures/PNG/TestPaletteBig.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTestPaletteBigInterlaced", "/Textures/PNG/TestPaletteBigInterlaced.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTestPaletteSmaller", "/Textures/PNG/TestPaletteSmaller.png", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PNGTestPaletteSmallest", "/Textures/PNG/TestPaletteSmallest.png", TRAP::Graphics::TextureUsage::Static);

	//PM
	TRAP::Graphics::TextureManager::Load("PMTest8BPPGrayscale", "/Textures/PM/Test8BPPGrayscale.pgm", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PMTest16BPPGrayscale", "/Textures/PM/Test16BPPGrayscale.pgm", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PMTest24BPP", "/Textures/PM/Test24BPP.ppm", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PMTest48BPP", "/Textures/PM/Test48BPP.ppm", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PMTestGrayscaleHDR", "/Textures/PM/TestGrayscaleHDR.pfm", TRAP::Graphics::TextureUsage::Static);
	TRAP::Graphics::TextureManager::Load("PMTestHDR", "/Textures/PM/TestHDR.pfm", TRAP::Graphics::TextureUsage::Static);

	//Radiance
	TRAP::Graphics::TextureManager::Load("RadianceTestHDR", "/Textures/Radiance/TestHDR.hdr", TRAP::Graphics::TextureUsage::Static);
