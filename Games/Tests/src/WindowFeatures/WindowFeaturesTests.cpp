...
void WindowFeaturesTests::OnImGuiRender()
{
	...
	//Window Position
	{
		...
		ImGui::Text("Position");
		ImGui::SameLine();
		changed += ImGui::InputInt("##PosX", &winPos[0], 0, ImGuiInputTextFlags_EnterReturnsTrue);
		ImGui::SameLine();
		changed += ImGui::InputInt("##PosY", &winPos[1], 0, ImGuiInputTextFlags_EnterReturnsTrue);
	...
	//Window Size
	{
		...
		ImGui::Text("Size");
		ImGui::SameLine();
		changed += ImGui::InputScalar("##SizeX", ImGuiDataType_U32, &winSize[0], nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
		ImGui::SameLine();
		changed += ImGui::InputScalar("##SizeY", ImGuiDataType_U32, &winSize[1], nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
	...
	//Minimum Size
	{
		...
		ImGui::SameLine();
		changed += ImGui::InputScalar("##MinSizeX", ImGuiDataType_U32, &m_minWindowSize[0], nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
		ImGui::SameLine();
		changed += ImGui::InputScalar("##MinSizeY", ImGuiDataType_U32, &m_minWindowSize[1], nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
	...
	//Maximum Size
	{
		...
		ImGui::SameLine();
		changed += ImGui::InputScalar("##MaxSizeX", ImGuiDataType_U32, &m_maxWindowSize[0], nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
		ImGui::SameLine();
		changed += ImGui::InputScalar("##MaxSizeY", ImGuiDataType_U32, &m_maxWindowSize[1], nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
