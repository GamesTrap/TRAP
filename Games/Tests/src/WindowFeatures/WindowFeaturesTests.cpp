...
void WindowFeaturesTests::OnImGuiRender()
{
	...
	//Window Position
	{
		...
		ImGui::Text("Position");
		ImGui::SameLine();
		changed += ImGui::InputInt("##PosX", &std::get<0>(winPos), 0, ImGuiInputTextFlags_EnterReturnsTrue);
		ImGui::SameLine();
		changed += ImGui::InputInt("##PosY", &std::get<1>(winPos), 0, ImGuiInputTextFlags_EnterReturnsTrue);
	...
	//Window Size
	{
		...
		ImGui::Text("Size");
		ImGui::SameLine();
		changed += ImGui::InputScalar("##SizeX", ImGuiDataType_U32, &std::get<0>(winSize), nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
		ImGui::SameLine();
		changed += ImGui::InputScalar("##SizeY", ImGuiDataType_U32, &std::get<1>(winSize), nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
	...
	//Minimum Size
	{
		...
		ImGui::SameLine();
		changed += ImGui::InputScalar("##MinSizeX", ImGuiDataType_U32, &std::get<0>(m_minWindowSize), nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
		ImGui::SameLine();
		changed += ImGui::InputScalar("##MinSizeY", ImGuiDataType_U32, &std::get<1>(m_minWindowSize), nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
	...
	//Maximum Size
	{
		...
		ImGui::SameLine();
		changed += ImGui::InputScalar("##MaxSizeX", ImGuiDataType_U32, &std::get<0>(m_maxWindowSize), nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
		ImGui::SameLine();
		changed += ImGui::InputScalar("##MaxSizeY", ImGuiDataType_U32, &std::get<1>(m_maxWindowSize), nullptr, nullptr, nullptr, ImGuiInputTextFlags_EnterReturnsTrue);
