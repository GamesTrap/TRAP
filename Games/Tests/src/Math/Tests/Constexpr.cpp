...
namespace Constexpr
{
    ...
    {
        {
            constexpr TRAP::Math::Vec2b b(true);
            constexpr bool a = TRAP::Math::All(b);
            static_assert(a, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec2b d(true, false);
            constexpr bool c = TRAP::Math::Any(d);
            static_assert(c, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec2b a(true);
            constexpr TRAP::Math::Vec2b b(true, false);
            static_assert(TRAP::Math::Any(TRAP::Math::Equal(a, b)), "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec2i a(1);
            static_assert(TRAP::Math::Vec2i(1) == a, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec2i a(1, 2);
            static_assert(TRAP::Math::Vec2i(1, 2) == a, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec2i a(TRAP::Math::Vec2(1, 2));
            static_assert(TRAP::Math::Vec2i(1, 2) == a, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec2i b(TRAP::Math::Vec3(1, 2, 3));
            static_assert(TRAP::Math::Vec2i(1, 2) == b, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec2i c(TRAP::Math::Vec4(1, 2, 3, 4));
        ...
        {
            constexpr TRAP::Math::Vec2b a1(true);
            constexpr TRAP::Math::Vec2b a2(true);
            constexpr TRAP::Math::Vec2b b1(false);
            constexpr TRAP::Math::Vec2b b2(false);
        ...
        {
            constexpr TRAP::Math::Vec2i a(1);
            constexpr TRAP::Math::Vec2i b = a + 1;
            constexpr TRAP::Math::Vec2i c(3);
            static_assert(a + b == c, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec2i d = +a;
            static_assert(d == a, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec2i a(3);
            constexpr TRAP::Math::Vec2i b = a - 1;
            constexpr TRAP::Math::Vec2i c(1);
            static_assert(a - b == c, "Math: Failed constexpr");
        ...
        {
            constexpr TRAP::Math::Vec2i a(3);
            constexpr TRAP::Math::Vec2i b = a % 2;
            constexpr TRAP::Math::Vec2i c(1);
        ...
        {
            constexpr TRAP::Math::Vec2i a(1);
            constexpr TRAP::Math::Vec2i b = a ^ 0;
            static_assert(a == b, "Math: Failed constexpr");
        ...
        {
            constexpr TRAP::Math::Vec2i a(~0);
            constexpr TRAP::Math::Vec2i b = ~a;
            static_assert(a == ~b, "Math: Failed constexpr");
        }
    }
...
//-------------------------------------------------------------------------------------------------------------------//
    ...
    {
        {
            constexpr TRAP::Math::Vec3b b(true);
            constexpr bool a = TRAP::Math::All(b);
            static_assert(a, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec3b d(true, false, true);
            constexpr bool c = TRAP::Math::Any(d);
            static_assert(c, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec3b a(true);
            constexpr TRAP::Math::Vec3b b(true, false, true);
            static_assert(TRAP::Math::Any(TRAP::Math::Equal(a, b)), "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec3i a(1);
            static_assert(TRAP::Math::Vec3i(1) == a, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec3i a(TRAP::Math::Vec2i(1, 2), 3);
            static_assert(TRAP::Math::Vec3i(1, 2, 3) == a, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec3i b(1, TRAP::Math::Vec2i(2, 3));
            static_assert(TRAP::Math::Vec3i(1, 2, 3) == b, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec3i a(1, 2, 3);
            static_assert(TRAP::Math::Vec3i(1, 2, 3) == a, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec3i a(TRAP::Math::Vec4i(1, 2, 3, 4));
            static_assert(TRAP::Math::Vec3i(1, 2, 3) == a, "Math: Failed constexpr");
        }
        ...
        {
            constexpr TRAP::Math::Vec3b a1(true);
            constexpr TRAP::Math::Vec3b a2(true);
            constexpr TRAP::Math::Vec3b b1(false);
            constexpr TRAP::Math::Vec3b b2(false);
            static_assert(a1 == a2 && b1 == b2, "Math: Failed constexpr");
            static_assert(a1 == a2 || b1 == b2, "Math: Failed constexpr");
        }
        ...
        {
            constexpr TRAP::Math::Vec3i a(1);
            constexpr TRAP::Math::Vec3i b = a + 1;
            constexpr TRAP::Math::Vec3i c(3);
            static_assert(a + b == c, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec3i d = +a;
            static_assert(d == a, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec3i a(3);
            constexpr TRAP::Math::Vec3i b = a - 1;
            constexpr TRAP::Math::Vec3i c(1);
            static_assert(a - b == c, "Math: Failed constexpr");
        ...
        {
            constexpr TRAP::Math::Vec3i a(3);
            constexpr TRAP::Math::Vec3i b = a % 2;
            constexpr TRAP::Math::Vec3i c(1);
            static_assert(b == c, "Math: Failed constexpr");
        ...
        {
            constexpr TRAP::Math::Vec3i a(1);
            constexpr TRAP::Math::Vec3i b = a ^ 0;
            static_assert(a == b, "Math: Failed constexpr");
        ...
        {
            constexpr TRAP::Math::Vec3i a(~0);
            constexpr TRAP::Math::Vec3i b = ~a;
            static_assert(a == ~b, "Math: Failed constexpr");
        }
    }
...
//-------------------------------------------------------------------------------------------------------------------//
    ...
    {
        {
            constexpr TRAP::Math::Vec4b b(true);
            constexpr bool a = TRAP::Math::All(b);
            static_assert(a, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4b d(true, false, true, false);
            constexpr bool c = TRAP::Math::Any(d);
            static_assert(c, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec4b a(true);
            constexpr TRAP::Math::Vec4b b(true, false, true, false);
            static_assert(TRAP::Math::Any(TRAP::Math::Equal(a, b)), "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec4i o(TRAP::Math::Vec4i(1));
            static_assert(TRAP::Math::Vec4i(1) == o, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4i a(1);
            static_assert(TRAP::Math::Vec4i(1) == a, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4i n(TRAP::Math::Vec4i(1, 2, 3, 4));
            static_assert(TRAP::Math::Vec4i(1, 2, 3, 4) == n, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec4i a(TRAP::Math::Vec3i(1, 2, 3), 4);
            static_assert(TRAP::Math::Vec4i(1, 2, 3, 4) == a, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4i b(TRAP::Math::Vec2i(1, 2), TRAP::Math::Vec2i(3, 4));
            static_assert(TRAP::Math::Vec4i(1, 2, 3, 4) == b, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4i c(1, TRAP::Math::Vec3i(2, 3, 4));
            static_assert(TRAP::Math::Vec4i(1, 2, 3, 4) == c, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4i d(1, TRAP::Math::Vec2i(2, 3), 4);
            static_assert(TRAP::Math::Vec4i(1, 2, 3, 4) == d, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4i e(TRAP::Math::Vec2i(1, 2), 3, 4);
            static_assert(TRAP::Math::Vec4i(1, 2, 3, 4) == e, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4i f(1, 2, TRAP::Math::Vec2i(3, 4));
        ...
        {
            constexpr TRAP::Math::Vec4b a1(true);
            constexpr TRAP::Math::Vec4b a2(true);
            constexpr TRAP::Math::Vec4b b1(false);
            constexpr TRAP::Math::Vec4b b2(false);
            static_assert(a1 == a2 && b1 == b2, "Math: Failed constexpr");
            static_assert(a1 == a2 || b1 == b2, "Math: Failed constexpr");
        }
        ...
        {
            constexpr TRAP::Math::Vec4i a(1);
            constexpr TRAP::Math::Vec4i b = a + 1;
            constexpr TRAP::Math::Vec4i c(3);
            static_assert(a + b == c, "Math: Failed constexpr");

            constexpr TRAP::Math::Vec4i d = +a;
            static_assert(d == a, "Math: Failed constexpr");
        }

        {
            constexpr TRAP::Math::Vec4i a(3);
            constexpr TRAP::Math::Vec4i b = a - 1;
            constexpr TRAP::Math::Vec4i c(1);
            static_assert(a - b == c, "Math: Failed constexpr");
        ...
        {
            constexpr TRAP::Math::Vec4i a(3);
            constexpr TRAP::Math::Vec4i b = a % 2;
            constexpr TRAP::Math::Vec4i c(1);
            static_assert(b == c, "Math: Failed constexpr");
        ...
        {
            constexpr TRAP::Math::Vec4i a(1);
            constexpr TRAP::Math::Vec4i b = a ^ 0;
            static_assert(a == b, "Math: Failed constexpr");
        ...
        {
            constexpr TRAP::Math::Vec4i a(~0);
            constexpr TRAP::Math::Vec4i b = ~a;
            static_assert(a == ~b, "Math: Failed constexpr");
        }
    }
